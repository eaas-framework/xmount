...
#define libcstring_wide_string_to_signed_long_long( string, end_of_string, base ) \
 ...
 */
#if defined( WINAPI ) && !defined( __CYGWIN__ )
#define libcstring_wide_string_to_unsigned_long_long( string, end_of_string, base ) \
