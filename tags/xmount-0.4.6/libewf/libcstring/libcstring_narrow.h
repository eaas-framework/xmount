 ...
 */
#if defined( HAVE_GLIB_H )
#define libcstring_narrow_string_to_signed_long_long( string, end_of_string, base ) \
	(int64_t) g_ascii_strtoll( string, end_of_string, base )

#elif defined( WINAPI ) && !defined( __CYGWIN__ )
#define libcstring_narrow_string_to_signed_long_long( string, end_of_string, base ) \
 ...
 */
#if defined( HAVE_GLIB_H )
#define libcstring_narrow_string_to_unsigned_long_long( string, end_of_string, base ) \
