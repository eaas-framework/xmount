...
#include "libcstring_narrow.h"
#include "libcstring_types.h"
#include "libcstring_wide.h"
...
#define libcstring_system_string_to_signed_long_long( string, end_of_string, base ) \
	libcstring_wide_string_to_signed_long_long( string, end_of_string, base )

#define libcstring_system_string_to_unsigned_long_long( string, end_of_string, base ) \
	libcstring_wide_string_to_unsigned_long_long( string, end_of_string, base )
...
#define libcstring_system_string_to_signed_long_long( string, end_of_string, base ) \
	libcstring_narrow_string_to_signed_long_long( string, end_of_string, base )

#define libcstring_system_string_to_unsigned_long_long( string, end_of_string, base ) \
	libcstring_narrow_string_to_unsigned_long_long( string, end_of_string, base )
