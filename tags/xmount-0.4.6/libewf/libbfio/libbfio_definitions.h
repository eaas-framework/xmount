 ...
 */
#else
#define LIBBFIO_VERSION					20110921

/* The libbfio version string
 */
#define LIBBFIO_VERSION_STRING				"20110921"
...
#define LIBBFIO_POOL_UNLIMITED_AMOUNT_OF_OPEN_HANDLES	LIBBFIO_POOL_UNLIMITED_NUMBER_OF_OPEN_HANDLES
