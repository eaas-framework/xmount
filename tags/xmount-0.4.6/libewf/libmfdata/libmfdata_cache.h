...
#if !defined( _LIBMFDATA_INTERNAL_CACHE_H )
#define _LIBMFDATA_INTERNAL_CACHE_H
...
typedef struct libmfdata_internal_cache libmfdata_internal_cache_t;

struct libmfdata_internal_cache
{
	/* The cache entries (array)
	 */
	libmfdata_array_t *entries;
