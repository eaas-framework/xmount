	...
	if( *handle != NULL )
	{
		...
		*handle = NULL;
		...
		if( libodraw_array_free(
		     &( internal_handle->data_file_descriptors_array ),
		     (int (*)(intptr_t **, liberror_error_t **)) &libodraw_data_file_descriptor_free,
		     error ) != 1 )
		{
			liberror_error_set(
			 error,
		...
		if( libodraw_array_free(
		     &( internal_handle->sessions_array ),
		     (int (*)(intptr_t **, liberror_error_t **)) &libodraw_sector_range_free,
		     error ) != 1 )
		{
			liberror_error_set(
			 error,
		...
		if( libodraw_array_free(
		     &( internal_handle->tracks_array ),
		     (int (*)(intptr_t **, liberror_error_t **)) &libodraw_track_value_free,
		     error ) != 1 )
		{
			liberror_error_set(
			 error,
