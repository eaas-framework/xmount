...
#define libcstring_string_to_signed_long_long( string, end_of_string, base ) \
	libcstring_narrow_string_to_signed_long_long( (char *) string, (char **) end_of_string, base )

#define libcstring_string_to_unsigned_long_long( string, end_of_string, base ) \
	libcstring_narrow_string_to_unsigned_long_long( (char *) string, (char **) end_of_string, base )
