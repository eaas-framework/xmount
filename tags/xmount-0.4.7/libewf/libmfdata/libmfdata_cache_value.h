...
#if !defined( _LIBMFDATA_CACHE_VALUE_H )
#define _LIBMFDATA_CACHE_VALUE_H
...
typedef struct libmfdata_cache_value libmfdata_cache_value_t;

struct libmfdata_cache_value
{
