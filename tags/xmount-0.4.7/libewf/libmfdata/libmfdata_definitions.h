 ...
 */
#else
#define LIBMFDATA_VERSION						20110731

/* The libmfdata version string
 */
#define LIBMFDATA_VERSION_STRING					"20110731"
...
enum LIBMFDATA_RANGE_FLAGS
{
	 ...
	 */
        LIBMFDATA_RANGE_FLAG_IS_TAINTED					= 0x00000010UL,

	/* The range is corrupted
	 */
        LIBMFDATA_RANGE_FLAG_IS_CORRUPTED				= 0x00000020UL,
